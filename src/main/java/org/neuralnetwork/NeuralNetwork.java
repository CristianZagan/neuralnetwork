...
public class NeuralNetwork implements Serializable {
    ...
    private double finaLearningRate = 0.001;
    ...
    public void setLearningRates(double initialLearningRate, double finaLearningRate) {
        this.initialLearningRate = initialLearningRate;
        this.finaLearningRate = finaLearningRate;
    }
    ...
    public void fit(Loader trainLoader, Loader evalLoader) {
        ...
        for (int epoch = 0; epoch < epochs; epoch++) {
            ...
            learningRate -= (initialLearningRate - finaLearningRate) / epochs;
        }
    }
